...
# This suite ensures that the C extension produces results within
# an acceptable delta of those produced by the native code.
#
# As the C extension is currently unsupported under Windows,
# we skip these tests on that platform.
